...
[ ! -d /var/lib/machines/debian/home/u1000 ] && debootstrap --variant=minbase --no-check-gpg --no-check-certificate --log-extra-deps bullseye /var/lib/machines/debian https://mirrors.bfsu.edu.cn/debian
