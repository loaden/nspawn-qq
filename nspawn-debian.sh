...
[ ! -d /var/lib/machines/debian/home/u1000 ] && debootstrap --variant=minbase --include=systemd-container --no-check-gpg bullseye /var/lib/machines/debian https://mirrors.bfsu.edu.cn/debian
