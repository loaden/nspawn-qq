...
[ ! -d /var/lib/machines/debian/home/u1000 ] && debootstrap --variant=minbase --include=systemd-container,dex,sudo,locales,pulseaudio,bash-completion --no-check-gpg buster /var/lib/machines/debian https://mirrors.tuna.tsinghua.edu.cn/debian
